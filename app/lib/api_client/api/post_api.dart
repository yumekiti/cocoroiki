...
class PostApi {
  ...
  /// Performs an HTTP 'DELETE /posts/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [num] id (required):
  ///   
  Future<Response> deletePostsIdWithHttpInfo(num id,) async {
  ...
  /// * [num] id (required):
  ///   
  Future<int?> deletePostsId(num id,) async {
    final response = await deletePostsIdWithHttpInfo(id,);
  ...
  /// Performs an HTTP 'GET /posts' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] sort:
  ...
  /// * [String] locale:
  ///   Locale to apply
  Future<PostListResponse?> getPosts({ String? sort, bool? paginationLeftSquareBracketWithCountRightSquareBracket, int? paginationLeftSquareBracketPageRightSquareBracket, int? paginationLeftSquareBracketPageSizeRightSquareBracket, int? paginationLeftSquareBracketStartRightSquareBracket, int? paginationLeftSquareBracketLimitRightSquareBracket, String? fields, String? populate, Object? filters, String? locale, }) async {
    final response = await getPostsWithHttpInfo( sort: sort, paginationLeftSquareBracketWithCountRightSquareBracket: paginationLeftSquareBracketWithCountRightSquareBracket, paginationLeftSquareBracketPageRightSquareBracket: paginationLeftSquareBracketPageRightSquareBracket, paginationLeftSquareBracketPageSizeRightSquareBracket: paginationLeftSquareBracketPageSizeRightSquareBracket, paginationLeftSquareBracketStartRightSquareBracket: paginationLeftSquareBracketStartRightSquareBracket, paginationLeftSquareBracketLimitRightSquareBracket: paginationLeftSquareBracketLimitRightSquareBracket, fields: fields, populate: populate, filters: filters, locale: locale, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PostListResponse',) as PostListResponse;
    
    }
    return null;
  }

  /// Performs an HTTP 'GET /posts/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [num] id (required):
  ///   
  Future<Response> getPostsIdWithHttpInfo(num id,) async {
    // ignore: prefer_const_declarations
    final path = r'/posts/{id}'
      .replaceAll('{id}', id.toString());
  ...
  /// * [num] id (required):
  ///   
  Future<PostResponse?> getPostsId(num id,) async {
    final response = await getPostsIdWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PostResponse',) as PostResponse;
    
    }
    return null;
  }

  /// Performs an HTTP 'POST /posts' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [PostRequest] postRequest (required):
  Future<Response> postPostsWithHttpInfo(PostRequest postRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/posts';

    // ignore: prefer_final_locals
    Object? postBody = postRequest;
  ...
  ///
  /// * [PostRequest] postRequest (required):
  Future<PostResponse?> postPosts(PostRequest postRequest,) async {
    final response = await postPostsWithHttpInfo(postRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'PUT /posts/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [num] id (required):
  ///   
  ///
  /// * [PostRequest] postRequest (required):
  Future<Response> putPostsIdWithHttpInfo(num id, PostRequest postRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/posts/{id}'
      .replaceAll('{id}', id.toString());
  ...
  ///
  /// * [PostRequest] postRequest (required):
  Future<PostResponse?> putPostsId(num id, PostRequest postRequest,) async {
    final response = await putPostsIdWithHttpInfo(id, postRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
