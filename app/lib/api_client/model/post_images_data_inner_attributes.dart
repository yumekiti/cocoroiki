...
class PostImagesDataInnerAttributes {
  /// Returns a new [PostImagesDataInnerAttributes] instance.
  PostImagesDataInnerAttributes({
    this.name,
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  AppUserFamiliesDataInnerAttributesKidsDataInnerAttributesFamilies? related;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  PostImagesDataInnerAttributesFolder? folder;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PostImagesDataInnerAttributes &&
     other.name == name &&
  ...
  @override
  String toString() => 'PostImagesDataInnerAttributes[name=$name, alternativeText=$alternativeText, caption=$caption, width=$width, height=$height, formats=$formats, hash=$hash, ext=$ext, mime=$mime, size=$size, url=$url, previewUrl=$previewUrl, provider=$provider, providerMetadata=$providerMetadata, related=$related, folder=$folder, folderPath=$folderPath, createdAt=$createdAt, updatedAt=$updatedAt, createdBy=$createdBy, updatedBy=$updatedBy]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.folderPath != null) {
      json[r'folderPath'] = this.folderPath;
    } else {
      json[r'folderPath'] = null;
    }
  ...
  /// Returns a new [PostImagesDataInnerAttributes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostImagesDataInnerAttributes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PostImagesDataInnerAttributes[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PostImagesDataInnerAttributes[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PostImagesDataInnerAttributes(
        ...
        formats: mapValueOfType<Object>(json, r'formats'),
        ...
        related: AppUserFamiliesDataInnerAttributesKidsDataInnerAttributesFamilies.fromJson(json[r'related']),
        folder: PostImagesDataInnerAttributesFolder.fromJson(json[r'folder']),
  ...
  static List<PostImagesDataInnerAttributes> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PostImagesDataInnerAttributes>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostImagesDataInnerAttributes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostImagesDataInnerAttributes> mapFromJson(dynamic json) {
    final map = <String, PostImagesDataInnerAttributes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostImagesDataInnerAttributes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PostImagesDataInnerAttributes-objects as value to a dart map
  static Map<String, List<PostImagesDataInnerAttributes>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostImagesDataInnerAttributes>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostImagesDataInnerAttributes.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
