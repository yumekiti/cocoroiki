...
class Profile {
  ...
  @override
  String toString() => 'Profile[user=$user, image=$image, content=$content, createdAt=$createdAt, updatedAt=$updatedAt, publishedAt=$publishedAt, createdBy=$createdBy, updatedBy=$updatedBy]';
  ...
  static Profile? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Profile(
        ...
        image: ProfileImage.fromJson(json[r'image']),
