...
class CommentCommentsDataInnerAttributesUserDataAttributes {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  CommentCommentsDataInnerAttributesUserDataAttributesFamilies? families;
  ...
  @override
  String toString() => 'CommentCommentsDataInnerAttributesUserDataAttributes[name=$name, email=$email, birth=$birth, age=$age, gender=$gender, lastLogin=$lastLogin, families=$families, grandparent=$grandparent, createdAt=$createdAt, updatedAt=$updatedAt, publishedAt=$publishedAt, createdBy=$createdBy, updatedBy=$updatedBy]';
  ...
  static CommentCommentsDataInnerAttributesUserDataAttributes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CommentCommentsDataInnerAttributesUserDataAttributes(
        ...
        families: CommentCommentsDataInnerAttributesUserDataAttributesFamilies.fromJson(json[r'families']),
