...
class UsersPermissionsPermissionsTreeValue {
  /// Returns a new [UsersPermissionsPermissionsTreeValue] instance.
  ...
  /// Returns a new [UsersPermissionsPermissionsTreeValue] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UsersPermissionsPermissionsTreeValue? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UsersPermissionsPermissionsTreeValue();
    }
    return null;
  }
  ...
  static List<UsersPermissionsPermissionsTreeValue> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UsersPermissionsPermissionsTreeValue.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
